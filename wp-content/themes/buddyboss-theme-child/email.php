...
// get_header(); 
                                ...
                                <tbody>
                                  <tr>
                                    <td bgcolor="#FFF" align="center" style="padding:40px 30px 40px 30px; border-radius:0px 0px 4px 4px; color:#666666; font-family:"Poppins"; font-size:18px; font-weight:400; line-height:25px;">
                                        <a href="" style="background-color:#FFE602; padding:8px 20px; border-radius:10px; text-decoration:none; font-weight:600; color:#333;">Read More</a>
                                    </td>
                                </tr>
                                    <tr>
                                    <td bgcolor="#FFF" align="center" style="padding:30px 30px 30px 30px; border-radius:4px 4px 4px 4px; color:#B2A6A3; font-family:"Poppins"; font-size:15px; font-weight:400; line-height:25px;">
                                        <p style="margin:0;">This email was sent by Coding Dojo</br>
                                        If you do not want to receive this type of email in the future, please <a href="contact" target="_blank" style="color:#0062cc;">unsubscribe</a>.</br>
   ...
   echo $message;
                 // wp_mail( "sonu@elicit.digital", $subject, $message, $headers );
               }
