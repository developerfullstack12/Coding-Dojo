    ...
    <?php else : ?>
      ...
      <div class="bb-header-buttons">
        ...
        <?php if ( get_option( 'users_can_register' ) ) : ?>
          ...
          <a href="<?php echo esc_url( wp_registration_url() ); ?>" class="button small singup signupbtn lrm-switch-to--register">

            <?php esc_html_e( 'Sign up', 'buddyboss-theme' ); ?></a>

        <?php endif; ?>

        <a href="<?php echo esc_url( wp_login_url() ); ?>" class="button small signin-button link signinbtn lrm-switch-to--login">

          <?php esc_html_e( 'Sign in', 'buddyboss-theme' ); ?></a>
